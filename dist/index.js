...
class Router extends _base2.default {
  setup() {
    var _this = this;

    return _asyncToGenerator(function* () {
      _this.app.router = (0, _koaRouter2.default)();
      _this.app.application.use(_this.app.router.routes());
      _this.app.application.use(_this.app.router.allowedMethods({
        throw: true,
